...
variables = []
variables.append(Variable("dimuon_mass", r"$m_{\mu\mu}$ [GeV]",
                          50, 110, 150))
variables.append(Variable("dimuon_mass_res", r"$\Delta M_{\mu\mu}$ [GeV]",
                          50, 0, 10))
variables.append(Variable("dimuon_mass_res_rel",
                          r"$\Delta M_{\mu\mu} / M_{\mu\mu}$ [GeV]",
                          50, 0, 0.1))
variables.append(Variable("dimuon_ebe_mass_res",
                          r"$\Delta M_{\mu\mu}$ [GeV]", 50, 0, 4))
variables.append(Variable("dimuon_ebe_mass_res_rel",
                          r"$\Delta M_{\mu\mu} / M_{\mu\mu}$ [GeV]",
                          50, 0, 0.04))
variables.append(Variable("dimuon_pt", r"$p_{T}(\mu\mu)$ [GeV]",
                          50, 0, 200))
variables.append(Variable("dimuon_pt_log", r"$log(p_{T}(\mu\mu))$",
                          50, 0, 200))
variables.append(Variable("dimuon_eta", r"$\eta (\mu\mu)$", 50, -5, 5))
variables.append(Variable("dimuon_phi", r"$\phi (\mu\mu)$",
                          50, -3.2, 3.2))
variables.append(Variable("dimuon_dEta", r"$\Delta\eta (\mu\mu)$",
                          50, 0, 10))
variables.append(Variable("dimuon_dPhi", r"$\Delta\phi (\mu\mu)$",
                          50, 0, 4))
variables.append(Variable("dimuon_dR", r"$\Delta R (\mu\mu)$",
                          50, 0, 4))
variables.append(Variable("dimuon_cos_theta_cs", r"$\cos\theta_{CS}$",
                          50, 0, 1))
variables.append(Variable("dimuon_phi_cs", r"$\phi_{CS}$", 50, 0, 6.5))
variables.append(Variable("mu1_pt", r"$p_{T}(\mu_{1})$ [GeV]",
                          40, 20, 200))
variables.append(Variable("mu1_pt_over_mass",
                          r"$p_{T}(\mu_{1})/M_{\mu\mu}$ [GeV]", 50, 0, 2))
...
variables.append(Variable("mu2_pt", r"$p_{T}(\mu_{2})$ [GeV]",
                          40, 20, 120))
variables.append(Variable("mu2_pt_over_mass",
                          r"$p_{T}(\mu_{2})/M_{\mu\mu}$ [GeV]", 50, 0, 2))
...
variables.append(Variable("mmj1_dEta", r"$\Delta\eta (\mu\mu, jet1)$",
                          50, 0, 10))
variables.append(Variable("mmj1_dPhi", r"$\Delta\phi (\mu\mu, jet1)$",
                          50, 0, 4))
...
variables.append(Variable("mmj2_dEta", r"$\Delta\eta (\mu\mu, jet2)$",
                          50, 0, 10))
variables.append(Variable("mmj2_dPhi", r"$\Delta\phi (\mu\mu, jet2)$",
                          50, 0, 4))
variables.append(Variable('jet1_has_matched_muon',
                          'jet1_has_matched_muon', 4, -1, 3))
variables.append(Variable('jet2_has_matched_muon',
                          'jet2_has_matched_muon', 4, -1, 3))
variables.append(Variable('jet1_matched_muon_dr', 'jet1_matched_muon_dr',
                          50, 0, 0.8))
variables.append(Variable('jet2_matched_muon_dr', 'jet2_matched_muon_dr',
                          50, 0, 0.8))
variables.append(Variable('jet1_matched_muon_pt', 'jet1_matched_muon_pt',
                          50, 0, 200))
variables.append(Variable('jet2_matched_muon_pt', 'jet2_matched_muon_pt',
                          50, 0, 200))
variables.append(Variable('jet1_matched_muon_iso',
                          'jet1_matched_muon_iso', 100, 0, 5))
variables.append(Variable('jet2_matched_muon_iso',
                          'jet2_matched_muon_iso', 100, 0, 5))
variables.append(Variable('jet1_matched_muon_id', 'jet1_matched_muon_id',
                          4, -1, 3))
variables.append(Variable('jet2_matched_muon_id', 'jet2_matched_muon_id',
                          4, -1, 3))
variables.append(Variable("mmj_min_dEta",
                          r"$min. \Delta\eta (\mu\mu, j)$", 50, 0, 10))
variables.append(Variable("mmj_min_dPhi",
                          r"$min. \Delta\phi (\mu\mu, j)$", 50, 0, 3.3))
...
variables.append(Variable("mmjj_mass", r"$M(\mu\mu jj)$ [GeV]",
                          50, 0, 1200))
variables.append(Variable("mmjj_pt", r"$p_{T}(\mu\mu jj)$ [GeV]",
                          50, 0, 150))
variables.append(Variable("mmjj_eta", r"$\eta (\mu\mu jj)$", 50, -7, 7))
variables.append(Variable("mmjj_phi", r"$\phi (\mu\mu jj)$",
                          50, -3.2, 3.2))
