...
from makeshapebased_datacard import buildDatacard
...
parser.add_argument(
    "--makeDatacards", default=False, help="Do you want to get bkg model from MC?"
)
...
def workflow(client, paths, parameters):
    ...
    if args.makeDatacards:
        ...
        Channels = ["ggh"]
        datacardpath = "./"
        buildDatacard(ws, bkgmodel, sigmodel, mass, tag, Channels, "uncertainty_v1.json", datacardpath)
