...
variables.append(Variable("mu1_eta", r"$\eta (\mu_{1})$", 50, -3, 3))
...
variables.append(Variable("mu2_eta", r"$\eta (\mu_{2})$", 50, -3, 3))
...
variables.append(Variable("jet1_eta", r"$\eta (jet1)$", 50, -5, 5))
...
variables.append(Variable("jet2_eta", r"$\eta (jet2)$", 50, -5, 5))
