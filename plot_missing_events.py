...
with uproot.open('/depot/cms/hmm/coffea/'
                 'pisa-jun12/data2018Snapshot.root') as f:
    tree = f['Events']
    ...
    for var in variables:
        if var.name not in var_map_pisa.keys():
            continue
        ...
        out_name = f"compare_with_pisa/"\
            f"plots_{args.year}_{args.label}_missing/"\
            f"{var.name}_h-peak.png"
