...
mva_bins = {
    'dnn_nominal': {
        '2016': [0, 0.158, 0.379, 0.582, 0.77,
                 0.945, 1.111, 1.265, 1.413, 1.553,
    ...
    'dnn_nominal_allyears_4layers': {
        '2016': [0, 0.168, 0.391, 0.588, 0.765,
                 ...
                 1.722, 1.884, 1.962, 2.3],
        '2017': [0, 0.319, 0.615, 0.841, 1.018,
                 1.17, 1.306, 1.438, 1.588, 1.748,
                 1.873, 1.937, 1.974, 2.3],
        '2018': [0, 0.069, 0.446, 0.724, 0.934,
                 1.112, 1.27, 1.421, 1.581, 1.748,
                 1.88, 1.942, 1.976, 2.3]
    },
    ...
    'dnn_allyears_64_128_128_64': {
        '2016': [],
        '2017': [0, 0.293, 0.592, 0.83, 1.019,
                 1.18, 1.328, 1.466, 1.609, 1.747,
                 1.864, 1.954, 2.009, 2.3],
        '2018': []
    },
    ...
    'bdt_jul15_earlystop50': {
        '2016': [0, 0.284, 0.575, 0.804, 1.0,
                 1.17, 1.328, 1.477, 1.623, 1.774,
                 1.93, 2.097, 2.29, 2.8],
        '2017': [0, 0.414, 0.747, 0.991, 1.182,
                 1.349, 1.499, 1.637, 1.777, 1.917,
                 2.062, 2.216, 2.392, 2.8],
        '2018': [0, 0.129, 0.627, 0.953, 1.195,
                 1.393, 1.565, 1.725, 1.875, 2.02,
                 2.164, 2.308, 2.471, 2.8],
    },
